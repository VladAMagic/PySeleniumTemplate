...
class TestLogin(BaseTest):
    def test_default_login(self):
        ...
        assert self.wait.until(expected_conditions.url_contains('?signin=true'))
    ...
    def test_failed_login(self):
        ...
        assert self.driver.find_element(*login_page.login_error).text.__contains__("Invalid Username")